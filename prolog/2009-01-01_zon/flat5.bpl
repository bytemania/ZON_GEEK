...
:-fuzzy_set(rental,[cheap(100,100,250,500),normal(100,300,400,600),expensive(300,450,600,600)]). 
...
:-fuzzy_set(conditions,[unfair(0,0,1,3),fair(1,3,6),good(4,6,8),excellent(7,9,10,10)]). 
...
close_to(Flat, District):-flat(Flat, Street, _, _), street(Street, Flat_Dist), distance(Flat_Dist, District, close).
